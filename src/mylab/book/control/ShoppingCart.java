    ...
    public void displayCart() {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            System.out.println((i+1) + ". " + item.getTitle() + " - " + 
                              String.format("%,d원", item.getPrice()));
        }
        System.out.println("총 가격: " + String.format("%,d원", calculateTotalPrice()));
        System.out.println("할인 적용 가격: " + 
                          String.format("%d원", calculateDiscountedPrice()));
    }
